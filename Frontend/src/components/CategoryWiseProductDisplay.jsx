          ...
          : data.map((product, index) => {
              return (
                <Link
                  ...
                  onClick={scrollTop}
                >
                  <div className="bg-slate-100 h-48 p-4 min-w-[280px] flex justify-center items-center">
                    <img
                  ...
                  <div className="p-4 grid gap-3">
                    ...
                    <button
                      className="text-sm bg-orange hover:bg-darkslategray-400 text-white px-3 py-0.5 rounded-full"
